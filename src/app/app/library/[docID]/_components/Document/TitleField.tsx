...
export default function TitleField() {
    ...
    return status === "succeeded" ? (
        <textarea
            ...
            className={`overflow-hidden h-min placeholder:text-slate-400 dark:placeholder:text-slate-600 w-full resize-none text-4xl bg-transparent focus:outline-none font-bold text-slate-700 dark:text-slate-300`}
        />
    ) : (
